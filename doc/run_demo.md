...
- The optional direct AQ browse test can report `ORA-24003` even when OKafka later consumes. Use real partition assignments and the Java consumer log as the source of truth.
